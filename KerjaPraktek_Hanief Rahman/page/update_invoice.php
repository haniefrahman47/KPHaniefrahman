  ...
  <div class="sidebar">
    ...
    <nav class="mt-2">
      ...
      <ul class="nav-item mx">
        ...
        <div class="col-12">
                  <div class="container">
                  <h2 class="mb-5"><ion-icon name="card-outline"></ion-icon>Edit Data Invoice</h2>
        ...
        <div class="col">
          <div class=" multi-collapse" id="multiCollapseExample1">
            <div class="card card-body">
              ...
              <?php
                ...
                $id_invocie = $_GET['id'];
                $get_invoice = $koneksi->query("SELECT * FROM tbl_invoice where id_invoice = '$id_invocie'");
                $get_invoice = $get_invoice->fetch_assoc();

              ?>
              
              <form action="../module/invoice_input.php" method="post">
          <div class="card-body">
              <!-- ------------------------------------------------------------------------------------------------------------------- -->
          ...
          <div class="row">
              ...
              <div class="form-group">
                ...
                <input type="number" class="form-control" name="no_invoice" placeholder="Masukan Nama Pelanggan">
              </div>
              <!-- ------------------------------------------------------------------------------------------------------------------- -->
              <div class="row">
                <div class="col">
              ...
              <input type="hidden" name="total_amount" id="total_amount" value="<?php echo $get_invoice['total_amount']; ?>">
              <!-- ------------------------------------------------------------------------------------------------------------------- -->
              <div class="form-group">
                <label for="exampleInputText">Catatan</label>
                <input type="text" class="form-control" name="catatan" placeholder="Masukan" value="<?php echo $get_invoice['catatan']; ?>" >
              </div>
            </div>
            <div class="card-footer">
              <button type="submit" name="invoice" class="btn btn-primary">Masukan</button>
                  ...
                  <?php 
                    ...
                    $invoice = mysqli_query($koneksi, "SELECT * from tbl_invoice, tbl_pelanggan, tbl_order where tbl_invoice.pelanggan = tbl_pelanggan.id_pelanggan and tbl_invoice.id_order = tbl_order.id_order");
                    ...
                    while($data = mysqli_fetch_array($invoice)){
                      ?>
                      <tr>
                        <td>INV-<?php echo $data['no_invoice']; ?></td>
                        <td><?php echo $data['tanggal']; ?></td>
                        <td><?php echo $data['nama']; ?></td>
                        <td>Rp.<?php echo $data['total_amount']; ?></td>
                        <td>
                          <a value=user name=user href="update_invoice.php?aksi=invoice&id=<?php echo $data['id_invoice']; ?>"><ion-icon name="create-outline"></ion-icon>&nbsp;&nbsp;&nbsp;</a>
                          <a value=user name=user href='../module/delete_process.php?aksi=invoice&id=<?php echo $data['id_invoice']; ?>''><ion-icon name="trash-outline"></ion-icon></a>					
                        </td>
                        <td>
                        &nbsp;&nbsp;&nbsp;<a value=user name=user href='../module/delete_process.php?aksi=pelanggan&id=<?php echo $data['id_pelanggan']; ?>''><ion-icon name="print-outline"></ion-icon></a>					
                          </td>
                        </tr>
                      <?php } ?>
                  </tbody>
