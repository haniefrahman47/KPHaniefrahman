  ...
  <div class="sidebar">
    ...
    <nav class="mt-2">
      ...
      <ul class="nav-item mx">
        ...
        <div class="col-12">
                  <div class="container">
                  <h2 class="mb-5"><ion-icon name="card-outline"></ion-icon>Edit Data User</h2>
          ...
          <div class=" multi-collapse" id="multiCollapseExample1">
            <div class="card card-body">
              ...
              <?php
                ...
                $id = $_GET['id'];
                $get_user = $koneksi->query("SELECT * FROM user where id_user = '$id'");
              ...
              <form action="../module/update_process.php" method="post">
                <div class="card-body">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="nama" placeholder="Masukan nama" value="<?php echo $get_user['nama']; ?>">
                        </div>
                        <div class="form-group">
                          <label for="exampleInputNumber">Email</label>
                          <input type="text" class="form-control" name="email" placeholder="Masukan email"  value="<?php echo $get_user['email']; ?>">
                        </div>
                        <div class="form-group">
                          <label for="exampleInputNumber1">Username</label>
                          <input type="text" class="form-control" name="username" placeholder="Masukan username"  value="<?php echo $get_user['username']; ?>">
                        </div>
                        <div class="form-group">
                          <label for="exampleInputNumber1">Password</label>
                          <input type="password" class="form-control" name="password" placeholder="Masukan password"  value="<?php echo $get_user['password']; ?>">
                        </div>
                      </div>
