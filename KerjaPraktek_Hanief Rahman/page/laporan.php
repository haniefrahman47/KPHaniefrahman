      ...
      <div class="col">
        <div class="row">
          <div class="col-lg-3 col-6">
            <a href="../p_bulan.php" type="button" class="btn btn-dark btn-lg btn-block">Laporan Bulanan</a>
            <br>
            <a href="../p_tahun.php" type="button" class="btn btn-dark btn-lg btn-block">Laporan Tahunan</a>
          </div>
    </div>
      </main>
       </body>
