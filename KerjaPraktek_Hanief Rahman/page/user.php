...
<br>
        ...
        <div class="col-12">
                  <div class="container">
                  <h2><ion-icon name="people-outline"></ion-icon>Users</h2>
              ...
              <form action="../module/input_process.php" method="post">
                <div class="card-body">
                      ...
                      <div class="card-footer">
                        <button type="submit" name="daftar" value="daftar" class="btn btn-primary">Masukan</button>
                      </div>
        </form>
            </div>
          </div>
                  ...
                  <tbody>
                    ...
                    while($data = mysqli_fetch_array($user)){
                      ...
                      <tr>
                        ...
                        <td>
                          <a value=user name=user href="update_user.php?aksi=user&id=<?php echo $data['id_user']; ?>"><ion-icon name="create-outline"></ion-icon>&nbsp;&nbsp;&nbsp;</a>
                          <a value=user name=user href='../module/delete_process.php?aksi=user&id=<?php echo $data['id_user']; ?>'><ion-icon name="trash-outline"></a>					
                        </td>
                      </tr>
                      <?php } ?>
